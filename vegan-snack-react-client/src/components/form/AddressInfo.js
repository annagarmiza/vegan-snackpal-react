...
const AddressInfo = () => {
  ...
  // } = useInput((event, value) => {
  //   console.log(value);
  //   if (value.label.trim() === "") {
  //     return { error: false, errorMessage: "Please select your country" };
  //   } else {
  ...
  //     return {
  //       error: false,
  //       errorMessage: "Field should include English letters and numbers only",
  //     };
  //   } else {
  //     return { error: true, errorMessage: "" };
  //   }
